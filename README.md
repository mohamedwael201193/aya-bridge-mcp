...
│   │   ├── analyze_bridge_route.ts
│   │   ├── calculate_bridge_costs.ts
│   │   ├── assess_bridge_risks.ts
│   │   ├── execute_bridge_transaction.ts
│   │   ├── monitor_bridge_status.ts
│   │   ├── find_yield_opportunities.ts
│   │   ├── optimize_gas_strategy.ts
│   │   └── emergency_bridge_pause.ts
